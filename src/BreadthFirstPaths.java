...
public class BreadthFirstPaths {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("This output was generated by Munira Tabassum");
        StdOut.println("Exercise 3: DFS paths search outputs for " + fileName);
        In in = new In(fileName);
        Graph G = new Graph(in);

        StdOut.println();
        StdOut.println("Enter a valid vertex.");
        int s = StdIn.readInt();
